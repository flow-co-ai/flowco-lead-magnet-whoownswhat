...
/* ============================================================
   EMAIL GATE — 3 fields + Monday.com sync
   ============================================================ */
...
gateForm.addEventListener("submit", async (e) => {
  ...
  // Fire to Monday — non-blocking, UX doesn't wait on it
...
document.addEventListener("mouseover", (e) => { if (e.target.closest(hotSel)) ring.classList.add("hot"); });
document.addEventListener("mouseout",  (e) => { if (e.target.closest(hotSel)) ring.classList.remove("hot"); });
